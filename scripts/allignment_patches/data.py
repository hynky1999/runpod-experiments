...
def get_datasets(
    ...
    if max_train_samples is not None and "train" in raw_datasets:
        raw_datasets["train"] = raw_datasets["train"].select(range(max_train_samples))
    if max_eval_samples is not None and "test" in raw_datasets:
    ...
    for ds, frac in dataset_mixer.items():
        ...
        for split in splits:
            try:
                ...
                print(f"Loading dataset {ds} with split {split}")
