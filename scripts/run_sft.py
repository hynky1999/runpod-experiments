...
def cp_metrics(eval: EvalPrediction):
    ...
    accuracy = (predicted_logits == eval.label_ids.cpu()).mean()
...
from allignment_patches.model_utils import get_tokenizer
from allignment_patches.data import get_datasets
